...
| Main history search | `ClipSearch`, `GRDBClipboardStore` | Main search offers FTS exact, fuzzy, and regex modes | Search and performance tests |
...
| Current direct download | GitHub release `v0.5.0`, release QA evidence | The v0.5.0 DMG is Developer ID-signed, notarized, stapled, and accepted by Gatekeeper | Version sync plus explicit release-copy assertions |
