...
- **Prose:** all project documentation is English unless the maintainer
  ...
  the first UI string (enforced by a LocalizationTests gate).
...
- **Product decisions live in the maintainer's private planning docs**
  (not committed). Do not re-litigate them in code comments. Committed text —
